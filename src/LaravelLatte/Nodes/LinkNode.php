...
namespace MarvelousMartin\LaravelLatte\Nodes;
...
class LinkNode extends StatementNode
{
    ...
    public function print(PrintContext $context): string
    {
        if ($this->mode === 'href') {
            ...
            $res = $context->format(
                <<<'XX'
                    echo ' href="'; echo %modify(\MarvelousMartin\LaravelLatte\LatteFunctions::link(%node, %node?)) %line; echo '"';
                    XX,
                $this->modifier,
                $this->destination,
                $this->args,
        ...
        return $context->format(
            'echo %modify(\MarvelousMartin\LaravelLatte\LatteFunctions::link(%node, %node?)) %line;',
            $this->modifier,
            $this->destination,
            $this->args,
            $this->position,
